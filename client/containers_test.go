...
const EVENTSTORE_DOCKER_REPOSITORY = "jrcollinson/eventstore_testdata"
//const EVENTSTORE_DOCKER_TAG = "20.6.0-buster-slim"
const EVENTSTORE_DOCKER_TAG = "second"
...
func getDatabase(options *dockertest.RunOptions) *Container {
	...
	if err != nil {
		log.Fatalf("Could not create new docker pool. Reason: %v", err)
	}
