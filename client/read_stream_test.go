...
func TestReadStreamEventsForwardsFromZeroPosition(t *testing.T) {
	fmt.Printf("TestReadStreamEventsForwardsFromZeroPosition : ")
...
func TestReadStreamEventsBackwardsFromEndPosition(t *testing.T) {
	fmt.Printf("TestReadStreamEventsBackwardsFromEndPosition : ")
	...
	context, cancel := context.WithTimeout(context.Background(), time.Duration(15)*time.Second)
	defer cancel()
