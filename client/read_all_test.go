...
func TestReadAllEventsForwardsFromZeroPosition(t *testing.T) {
	fmt.Printf("TestReadAllEventsForwardsFromZeroPosition : ")
...
func TestReadAllEventsForwardsFromNonZeroPosition(t *testing.T) {
	fmt.Printf("TestReadAllEventsForwardsFromNonZeroPosition : ")
...
func TestReadAllEventsBackwardsFromZeroPosition(t *testing.T) {
	fmt.Printf("TestReadAllEventsBackwardsFromZeroPosition : ")
...
func TestReadAllEventsBackwardsFromNonZeroPosition(t *testing.T) {
	fmt.Printf("TestReadAllEventsBackwardsFromNonZeroPosition : ")
	...
	context, cancel := context.WithTimeout(context.Background(), time.Duration(30)*time.Second)
	defer cancel()
