...
func TestGossipEndPointDiscoverer_Unavailable(t *testing.T) {
	fmt.Printf("TestGossipEndPointDiscoverer_Unavailable : ")
...
func TestGossipEndPointDiscoverer_WithNoAliveNodes(t *testing.T) {
	fmt.Printf("TestGossipEndPointDiscoverer_WithNoAliveNodes : ")
...
func TestGossipEndPointDiscoverer_WithAliveLeader(t *testing.T) {
	fmt.Printf("TestGossipEndPointDiscoverer_WithAliveLeader")
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		gossipResponse := `
        {
...
func TestGossipEndPointDiscoverer_WithAliveLeaderAndFollowerAndNodePreferenceFollower(t *testing.T) {
	fmt.Printf("TestGossipEndPointDiscoverer_WithAliveLeaderAndFollowerAndNodePreferenceFollower : ")
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		gossipResponse := `
        {
