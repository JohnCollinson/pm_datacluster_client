...
func TestStreamSubscriptionDeliversAllowsCancellationDuringStream(t *testing.T) {
	fmt.Print("TestStreamSubscriptionDeliversAllowsCancellationDuringStream : ")
...
func TestStreamSubscriptionDeliversAllEventsInStreamAndListensForNewEvents(t *testing.T) {
	fmt.Printf("TestStreamSubscriptionDeliversAllEventsInStreamAndListensForNewEvents\n")
	container := GetPrePopulatedDatabase()
	defer container.Close()
	client := CreateTestClient(container, t)
	defer client.Close()
...
func TestAllSubscriptionDeliversAllowsCancellationDuringStream(t *testing.T) {
	fmt.Printf("TestAllSubscriptionDeliversAllowsCancellationDuringStream : ")
	container := GetPrePopulatedDatabase()
	defer container.Close()
	client := CreateTestClient(container, t)
	defer client.Close()
...
func TestAllSubscriptionWithFilterDeliversCorrectEvents(t *testing.T) {
	fmt.Printf("TestAllSubscriptionWithFilterDeliversCorrectEvents : ")
